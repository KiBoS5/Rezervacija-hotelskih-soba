...
<section>
  ...
  <article>
    <form id="rez" method="post" action="">
        <label> UNOS PODATAKA O GOSTIMA </label>
        <br>
    ...
    <input type="date" id="dat" name="dat">
        <br>
        <input type="submit" id="upisi" value="UPISI">
        <input type="submit" id="izmeni" value="IZMENI">
        <br>
        <input type="submit" id="obrisi" value="OBRISI">
        <input type="submit" id="izadji" value="IZADJI">
 </form>
        <p>UNJETI TABELU O PODATCIMA GOSTIJU</p>
        </article>
</section>
