...
<section>
  ...
  <article>
      <form id="rez" method="post" action="">
        <label> PRONADJI SLOBODNU SOBU </label>
        <br>
        <label for="date"> NA DAN  </label>
    ...
    <select>
        ...
        <br>
        <input type="submit" id="prikazi" value="PRIKAZI">
        <input type="submit" id="zbrisi" value="IZBRISI">
       <br>
          
          <p> UNJETI INTERAKTIVNU TABELU</p>
 </form>
        </article>
</section>
